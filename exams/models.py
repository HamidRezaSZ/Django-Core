...
class Exam(BaseModel):
    ...
    minimum_score = models.PositiveIntegerField(verbose_name=_("minimum_score"))
...
class DescriptiveAnswer(BaseModel):
    exam = models.OneToOneField(
        to=Exam, verbose_name=_("exam"), on_delete=models.CASCADE
    )
...
class Result(BaseModel):
    ...
    exam = models.ForeignKey(to=Exam, on_delete=models.CASCADE, verbose_name=_("exam"))
    parent = models.ForeignKey(
        to="self",
        on_delete=models.CASCADE,
        verbose_name=_("parent"),
    ...
    no_all_questions = models.PositiveIntegerField(verbose_name=_("no_all_questions"))
